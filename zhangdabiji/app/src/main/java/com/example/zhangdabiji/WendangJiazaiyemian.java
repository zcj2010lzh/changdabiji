...
public class  WendangJiazaiyemian  extends AppCompatActivity implements TbsReaderView.ReaderCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        QbSdk.initX5Environment(this, new QbSdk.PreInitCallback() {
            ...
            public void onViewInitFinished(boolean b) {
                Toast.makeText(WendangJiazaiyemian.this, "加载内核是否成功:"+b, Toast.LENGTH_SHORT).show();
